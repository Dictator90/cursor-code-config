...
SECRET_PATTERNS = [
    ...
    (re.compile(r'\bghp_[a-zA-Z0-9]{36}'), "code-hosting Personal Access Token (ghp_...)"),
    (re.compile(r'\bgho_[a-zA-Z0-9]{36}'), "code-hosting OAuth Token (gho_...)"),
    (re.compile(r'\bghs_[a-zA-Z0-9]{36}'), "code-hosting App Token (ghs_...)"),
